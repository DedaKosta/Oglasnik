      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <button
              type="button"
              className="w-full inline-flex justify-center items-center py-2.5 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all hover:shadow-md"
            >
            ...
            <button
              type="button"
              className="w-full inline-flex justify-center items-center py-2.5 px-4 border border-[#1877F2] rounded-lg shadow-sm bg-[#1877F2] text-sm font-medium text-white hover:bg-[#166FE5] transition-all hover:shadow-md"
            >
            ...
            <button
              type="button"
              className="w-full inline-flex justify-center items-center py-2.5 px-4 border-0 rounded-lg shadow-sm bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 text-sm font-medium text-white hover:from-purple-700 hover:via-pink-700 hover:to-orange-600 transition-all hover:shadow-md"
            >
              <svg className="w-5 h-5" fill="white" viewBox="0 0 24 24" aria-hidden="true">
